    ...
    @else
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="{{route('add-post')}}">
                                <i class="fas fa-plus-square"></i>Post</a>
                        </li>
                        <li>
                            <a href="{{url('all/post')}}">
                                <i class="fas fa-plus-square"></i>All Post</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="page-container">
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="{{asset('public/backend/images/icon/avatar-06.jpg')}}" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{asset('public/backend/images/icon/avatar-01.jpg')}}" alt="{{ Auth::user()->name }}" />
                                        </div>
                                        <div class="content">
            ...
            <div class="footer py-2">
                <div class="col-md-12">
                        <p>Copyright © 2020 Colorlib. All rights reserved.  <a href="{{url('/')}}">Aqua Zone</a>.</p>
                </div>
            </div>
        </div>
    @endguest
